...
<a class="list-group-item" href="config.php?display=systemadmin&view=dns">DNS</a>
<a class="list-group-item" href="config.php?display=systemadmin&view=timezone">Timezone</a>
<a class="list-group-item" href="config.php?display=systemadmin&view=hostname">Hostname</a>
